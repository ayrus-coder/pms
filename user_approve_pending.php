...
<div class="panel panel-info">
        <div class="panel panel-heading"> For host <span class="label label-success"><?php echo $result['hostname']; ?> </span></div>
...
?>
<div class="panel panel-info">
	<div class="panel panel-heading"> For host <span class="label label-warning"><?php echo $result['hostname']; ?> </span></div>
	<div class="panel panel-body">
 	<div class="row">
	<div class="col-md-6">
		<div>
...
if($count<1) {
?>
<h2><span style="color:#f0ad4e;" class="glyphicon glyphicon-warning-sign"></span> You have no pending maintenance requests</h2>
<?php
}
if($edit) {
?>
