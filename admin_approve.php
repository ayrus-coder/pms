...
<div class="panel panel-info">
        <div class="panel panel-heading"> For host <span class="label label-<?php echo ($result['status'] == 'PENDING')?'warning':'success'; ?>"><?php echo $result['hostname']; ?> </span></div>
	...
	<div class="col-md-6">
		<div>
			...
			<span class="label label-<?php echo ($result['status'] == 'PENDING')?'warning':'success'; ?>"><?php echo $result['status']; ?></span>
		</div>
		<div>
		...
		<div>
			...
			<span class="label label-default"><?php echo ($result['approved']=='Y')?$result['updated_date']:""; ?></span>
		</div>
		<div>
